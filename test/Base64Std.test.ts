...
describe("Base64 standard tests", function () {
  ...
  describe("Encode", function () {
    it("should convert to base64 encoded string with double padding", async function () {
    ...
    it("should convert to base64 encoded string with single padding", async function () {
    ...
    it("should convert to base64 encoded string without padding", async function () {
      const testMsg = "light work";
      const input = utils.toUtf8Bytes(testMsg);
      const encoded = await base64Test.encodeBase64Std(input);
  ...
  describe("Decode", function () {
    it("should decode base64 encoded string with double padding", async function () {
    ...
    it("should decode base64 encoded string with single padding", async function () {
      const encoded = "bGlnaHQgd29yay4=";
      const bytesMsg = await base64Test.decodeBase64Std(encoded);
      expect(utils.toUtf8String(bytesMsg)).deep.equal("light work.");
    });

    it("should decode base64 encoded string without padding", async function () {
